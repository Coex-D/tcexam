...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2023 at 08:07 PM
...
('b24dec426ea1ac50d65788651ae241be', '2023-08-29 00:36:15', 'session_hash|s:32:\"903e795600a3fb71d639987d9b87dc3d\";session_user_id|s:1:\"2\";session_user_name|s:5:\"admin\";session_user_ip|s:39:\"0000:0000:0000:0000:0000:ffff:7f00:0001\";session_user_level|s:2:\"10\";session_user_firstname|s:0:\"\";session_user_lastname|s:0:\"\";session_test_login|s:0:\"\";session_last_visit|i:1693245969;logout|b:1;');
...
(2, 'Python test', 'Testing how test works', '2023-08-22 16:15:00', '2023-08-23 18:00:00', 60, '*.*.*.*', 1, 1, '1.000', '0.000', '0.000', '2.000', 2, '0.000', 1, 1, 0, 1, 1, 0, 0, 1, 1, 1, 0, 1, 1, '$2y$10$PCTlNCdL//S7NrlDHK/qTOyuMmyCPCenHGuKsLSMI4Iqgzs9FIz9O'),
(5, 'Python test old', 'vipul kumar', '2023-08-22 12:23:00', '2023-08-23 12:23:00', 60, '*.*.*.*', 0, 0, '1.000', '0.000', '0.000', '1.000', 2, '0.000', 1, 1, 0, 1, 1, 0, 1, 1, 1, 1, 0, 1, 0, '$2y$10$5M7pQCDccR.lLwfwx2M71.8SWjhJEezH6yFLGQrSmuVfUEUd98w72'),
(6, 'python test expire', 'Vipul', '2023-08-23 11:31:00', '2023-08-23 13:05:00', 60, '*.*.*.*', 1, 1, '1.000', '0.000', '0.000', '1.000', 2, '0.000', 1, 1, 0, 1, 1, 0, 1, 1, 1, 1, 0, 1, 0, '$2y$10$McyFJ3h8iXYf59NadBMHWelSpD0kPImJbslOZgRWC/RKAeYhIqNsm'),
(7, 'python test expire new', 'terst', '2023-08-23 11:31:00', '2023-08-23 12:58:00', 60, '*.*.*.*', 0, 0, '1.000', '0.000', '0.000', '1.000', 2, '0.000', 1, 1, 0, 1, 1, 0, 1, 1, 1, 1, 0, 1, 0, '$2y$10$KwU30UJe700nj6auWx6xYu5u73sTUVT8w/TX9kaemnNxyD.gV8xTO'),
(8, 'CB new expite', 'buga', '2023-08-23 19:34:00', '2023-08-23 20:34:00', 60, '*.*.*.*', 0, 0, '1.000', '0.000', '0.000', '1.000', 2, '0.000', 1, 1, 0, 1, 1, 0, 1, 1, 1, 1, 0, 1, 0, '$2y$10$lzUe78ayhB1vxy/vzZTSNOGDjKk8jukzGhThjTQLurZWl4HsJvDWK'),
(9, 'vipul', 'rog fanga', '2023-08-23 17:35:00', '2023-08-23 17:40:00', 60, '*.*.*.*', 1, 1, '1.000', '0.000', '0.000', '2.000', 2, '0.000', 1, 1, 0, 1, 1, 0, 1, 1, 1, 1, 0, 1, 0, NULL);
...
(2, 2, '0000:0000:0000:0000:0000:ffff:7f00:0001', 1, NULL, '1.000', '2023-08-23 12:00:57', '2023-08-23 12:00:57', '2023-08-23 12:01:52', 4603, 1, 2, NULL),
(3, 2, '0000:0000:0000:0000:0000:ffff:7f00:0001', 3, NULL, '1.000', '2023-08-23 12:00:57', '2023-08-23 12:01:09', '2023-08-23 12:01:35', 25274, 2, 2, NULL);
...
(2, 2, 8, 4, '2023-08-23 12:00:57', NULL);
...
(2, '2023-08-23 12:00:57'),
(3, '2023-08-23 12:25:22');
...
(8, 'K22219', '$2y$10$Fo2B9MmnJLXVIgRpFwWFSOORqNz8v7YYEgxxsyvQV4TP8yG4uoPUO', NULL, '2023-08-22 11:23:07', '0000:0000:0000:0000:0000:ffff:7f00:0001', 'Vipul', 'Kumar', NULL, NULL, NULL, NULL, 1, NULL, NULL),
(9, 'K21552', '$2y$10$e6EvpECbS.cteHJIiSjS4elQdByUe0BINESb5V6w8FdxnDtbU1y/W', NULL, '2023-08-22 11:23:07', '0000:0000:0000:0000:0000:ffff:7f00:0001', 'Aman', 'Singh', NULL, NULL, NULL, NULL, 1, NULL, NULL);
...
--
ALTER TABLE `tce_tests`
  MODIFY `test_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `tce_tests_logs`
--
ALTER TABLE `tce_tests_logs`
  MODIFY `testlog_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tce_tests_users`
--
ALTER TABLE `tce_tests_users`
  MODIFY `testuser_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tce_testuser_stat`
--
ALTER TABLE `tce_testuser_stat`
  MODIFY `tus_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tce_test_subject_set`
--
ALTER TABLE `tce_test_subject_set`
  MODIFY `tsubset_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
